    ...
    void consume(Purchase itemInfo) throws IabException {
        ...
        try {
            ...
            if (response == BILLING_RESPONSE_RESULT_OK) {
                ...
                logDebug("Error consuming consuming sku " + sku + "build/intermediates/exploded-aar/com.google.firebase/firebase-analytics-impl/9.8.0/res " + getResponseDesc(response));
